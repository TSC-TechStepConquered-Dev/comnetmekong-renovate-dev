...
const MOCK_OUR_WORK_DATA = [
  {
    ...
    description: 'โครงการพัฒนาศักยภาพเยาวชนคนรุ่นใหม่ใส่ใจสื่อสร้างสรรค์ - เสริมทักษะเยาวชน 7 จังหวัดริมโขง ผ่านการอบรมและการผลิตสื่อสร้างสรรค์หลากหลายรูปแบบ...',
  ...
  },
  {
    ...
    description: 'เรียนรู้ระบบนิเวศ สำรวจลำน้ำ ปลูกพืช อนุรักษ์สัตว์น้ำ และสร้างสื่อเพื่อการเปลี่ยนแปลง พร้อมเปิดพื้นที่ความรู้ใหม่ให้กับเด็กลุ่มแม่น้ำโขง...',
    image: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?q=80&w=800&auto=format&fit=crop'
  },
  {
    id: 3,
    title: 'โครงการสื่อสารเชิงนโยบายเพื่อส่งเสริมการอนุรักษ์อย่างมีส่วนร่วมของชุมชนในพื้นที่เชื่อมต่อแม่น้ำโขงและปากชม',
    agency: 'CEPF - กองทุนเพื่อการอนุรักษ์ความหลากหลายทางชีวภาพ (2566-2567)',
    description: 'สำรวจความหลากหลายทางชีวภาพและระบบนิเวศย่อย โดยนักวิชาการและชุมชนร่วมกันเรียนรู้และวางแผนส่งเสริมแนวทางพัฒนาที่อิงธรรมชาติ ใน 13 ชุมชน...',
  ...
  },
  {
    ...
    description: 'ร่วมมือไทย-ลาวในการแลกเปลี่ยนข้อมูลการลดลงของปลาอีสกไทย จัดตั้งเขตอนุรักษ์ร่วม และส่งเสริมการมีส่วนร่วมของชุมชนในการอนุรักษ์...',
    image: 'https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?q=80&w=800&auto=format&fit=crop'
  },
  {
    id: 5,
    title: 'โครงการส่งเสริมการท่องเที่ยวชุมชนอุทยานธรณีผาชันสามพันโบกภายใต้หลักการพัฒนาอย่างยั่งยืน',
    agency: 'EU-UNDP โครงการพัฒนาแห่งสหประชาชาติ (2566-2567)',
    description: 'โครงการส่งเสริมการท่องเที่ยวชุมชนอุทยานธรณีผาชันสามพันโบกภายใต้หลักการพัฒนาอย่างยั่งยืน...',
    image: 'https://images.unsplash.com/photo-1473448912268-2022ce9509d8?q=80&w=800&auto=format&fit=crop'
  },
  {
    id: 6,
    title: 'โครงการพัฒนาศักยภาพเครือข่ายภาคประชาสังคมเพื่อสร้างการมีส่วนร่วมในการกำหนดอนาคตแม่น้ำโขง',
    agency: 'USAID-WWF องค์การกองทุนสัตว์ป่าโลกสากล (2566-2567)',
    description: 'สร้างการมีส่วนร่วมเพื่อปกป้องแม่น้ำโขง เชื่อมเครือข่ายองค์กรชุมชนและภาคประชาสังคมทุกระดับ...',
...
<template>
  <main class="min-h-screen bg-[#f4f1ea] font-sans">
    ...
    <section class="relative w-full h-[65vh] min-h-[250px] flex items-center justify-center overflow-hidden">
      ...
      <!-- Hero Content -->
      <div class="relative z-10 max-w-5xl mx-auto px-4 md:px-8 w-full mt-16 text-center flex flex-col justify-center items-center h-full">
        <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold uppercase tracking-wider flex items-center justify-center min-w-[280px] md:min-w-[450px] mb-6" style="text-shadow: 0 4px 20px rgba(0,0,0,0.3);">
          <span 
        ...
        <p class="text-stone-200 text-lg md:text-xl font-medium max-w-3xl leading-relaxed whitespace-pre-line" style="text-shadow: 0 2px 10px rgba(0,0,0,0.5);">
    ...
    <section class="relative z-20 w-full bg-[#f4f1ea] py-16 px-4 md:px-8 pb-32">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="w-full mb-12 hidden">
          <h2 class="text-3xl md:text-4xl font-black text-stone-900 tracking-tighter border-b-2 border-[#137333]/20 pb-4 inline-block">
            งานของเรา
          </h2>
        </div>

        <!-- Cards (Loading State) -->
        <div v-if="loadingData" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mt-8">
          <div v-for="i in 6" :key="i" class="animate-pulse bg-white rounded-3xl p-6 border border-stone-200 shadow-sm">
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mt-8">
          ...
          >
            ...
            <div class="p-6 md:p-8 flex flex-col flex-grow">
              <!-- Agency Badge -->
              <div class="mb-4">
                <span v-if="item.agency" class="inline-block px-4 py-1.5 bg-[#f0f8f1] text-[#2d6a4f] text-[11px] md:text-xs font-bold rounded-full tracking-wide">
                  {{ item.agency }}
                </span>
              </div>
              
              <!-- Title -->
              <h3 class="text-xl md:text-[22px] font-bold text-stone-900 mb-4 leading-snug line-clamp-2" :title="item.title">
                "{{ item.title }}"
              </h3>
              
              <!-- Description -->
              <div class="text-stone-600 leading-relaxed text-[15px] line-clamp-3" :title="item.description">
                {{ item.description }}
              </div>
            </div>
